...
options.t_itemname = {
	...
	['default'] = function(t, item, cursorPosY, moveTxt)
		if main.f_input(main.t_players, {'$F', '$B', 'pal', 's'}) then
			...
			config.TrngDummyMode = 0
			config.TrngDummyAction = 0
			config.TrngDummyGuard = 0
			config.TrngCounterHit = 0
			config.Trng1PHealthMeter = 0
			config.Trng2PHealthMeter = 0
			config.Trng1PPowerBar = 0
			config.Trng2PPowerBar = 0
			config.Trng1PStunBar = 0
			config.Trng2PStunBar = 0
			config.Trng1PGuardBar = 0
			config.Trng2PGuardBar = 0
